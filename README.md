...
> * 0.9 - Active - New features and some underlying architectural changes. Try the latest released version: [0.9.8100](https://github.com/meerk40t/meerk40t/releases/tag/0.9.8100) (Aug 15, 2025) or try a prerelease even: [release list](https://github.com/meerk40t/meerk40t/releases)

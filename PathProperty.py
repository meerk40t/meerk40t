...
class PathProperty(wx.Frame):
    ...
    def __set_properties(self):
        ...
        self.SetTitle("Path Properties")
        self.button_stroke_none.SetToolTip("\"none\" defined value")
        self.button_stroke_F00.SetBackgroundColour(wx.Colour(255, 0, 0))
        self.button_stroke_F00.SetToolTip("#FF0000 defined values.")
        self.button_stroke_0F0.SetBackgroundColour(wx.Colour(0, 255, 0))
        self.button_stroke_0F0.SetToolTip("#00FF00 defined values.")
        self.button_stroke_00F.SetBackgroundColour(wx.Colour(0, 0, 255))
        self.button_stroke_00F.SetToolTip("#00FF00 defined values.")
        self.button_stroke_F0F.SetBackgroundColour(wx.Colour(255, 0, 255))
        self.button_stroke_F0F.SetToolTip("#FF00FF defined values.")
        self.button_stroke_0FF.SetBackgroundColour(wx.Colour(0, 255, 255))
        self.button_stroke_0FF.SetToolTip("#00FFFF defined values.")
        self.button_stroke_FF0.SetBackgroundColour(wx.Colour(255, 255, 0))
        self.button_stroke_FF0.SetToolTip("#FFFF00 defined values.")
        self.button_stroke_000.SetBackgroundColour(wx.Colour(0, 0, 0))
        self.button_stroke_000.SetToolTip("#000000 defined values.")
        self.button_fill_none.SetToolTip("\"none\" defined value")
        self.button_fill_F00.SetBackgroundColour(wx.Colour(255, 0, 0))
        self.button_fill_F00.SetToolTip("#FF0000 defined values.")
        self.button_fill_0F0.SetBackgroundColour(wx.Colour(0, 255, 0))
        self.button_fill_0F0.SetToolTip("#00FF00 defined values.")
        self.button_fill_00F.SetBackgroundColour(wx.Colour(0, 0, 255))
        self.button_fill_00F.SetToolTip("#00FF00 defined values.")
        self.button_fill_F0F.SetBackgroundColour(wx.Colour(255, 0, 255))
        self.button_fill_F0F.SetToolTip("#FF00FF defined values.")
        self.button_fill_0FF.SetBackgroundColour(wx.Colour(0, 255, 255))
        self.button_fill_0FF.SetToolTip("#00FFFF defined values.")
        self.button_fill_FF0.SetBackgroundColour(wx.Colour(255, 255, 0))
        self.button_fill_FF0.SetToolTip("#FFFF00 defined values.")
        self.button_fill_000.SetBackgroundColour(wx.Colour(0, 0, 0))
        self.button_fill_000.SetToolTip("#000000 defined values.")
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_9 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, "Fill Color"), wx.VERTICAL)
        sizer_7 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, "Stroke Color"), wx.VERTICAL)

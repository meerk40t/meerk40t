...
COMMAND_CUT_LINE_TO = 101  # At speed, performs a line cut
COMMAND_CUT_CUBIC_TO = 102  # At speed, performs a cubic bezier cut
COMMAND_CUT_QUAD_TO = 103  # At speed, performs a quadratic bezier cut
COMMAND_CUT_ARC_TO = 104  # At speed, performs an arc cut

...
class RotarySettings(wx.Frame, Module):
    def __init__(self, parent, *args, **kwds):
        ...
        self.Bind(wx.EVT_TEXT, self.on_spin_rotary_roller_circumference, self.text_rotary_roller_circumference)
        self.Bind(wx.EVT_TEXT, self.on_spin_rotary_object_circumference, self.text_rotary_object_circumference)
        # end wxGlade
    ...
    def initialize(self, channel=None):
        ...
        self.text_rotary_scalex.SetValue(str(self.device.scale_x))
        self.text_rotary_scaley.SetValue(str(self.device.scale_y))
    ...
    def __set_properties(self):
        ...
        self.text_rotary_object_circumference.SetToolTip(_("Circumference of object in rotary"))
    ...
    def on_spin_rotary_roller_circumference(self, event):  # wxGlade: RotarySettings.<event_handler>
        if self.device is None: # TODO: 0.6.23
            return

...
from sefrocut.core.units import ACCEPTED_UNITS, Angle, Length
from sefrocut.fill.patterns import LivingHinges
from sefrocut.gui.icons import STD_ICON_SIZE, icon_hinges
from sefrocut.gui.laserrender import LaserRender
...
try:
    from sefrocut.tools.dual_algorithm_strategy import DualAlgorithmStrategy
    from sefrocut.tools.living_hinge_optimizer import LivingHingeOptimizer

    OPTIMIZATION_AVAILABLE = True
except ImportError:
    # Fallback if optimization modules are not available
    OPTIMIZATION_AVAILABLE = False
from sefrocut.kernel import signal_listener
from sefrocut.svgelements import Color, Matrix, Path

# from sefrocut.fill.patternfill import LivingHinges

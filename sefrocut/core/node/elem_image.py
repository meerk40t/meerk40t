...
from sefrocut.core.node.mixins import LabelDisplay, Suppressable
from sefrocut.core.node.node import Node
from sefrocut.core.units import UNITS_PER_INCH, UNITS_PER_MM
from sefrocut.image.imagetools import RasterScripts
from sefrocut.svgelements import Matrix, Path, Polygon
...
class ImageNode(Node, LabelDisplay, Suppressable):
    ...
    def _apply_dither(self, image):
        ...
        """
        from sefrocut.image.imagetools import dither

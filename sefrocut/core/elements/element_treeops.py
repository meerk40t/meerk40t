...
from sefrocut.core.node.node import Fillrule, Node
from sefrocut.core.treeop import (
    get_tree_operation,
    tree_calc,
    tree_check,
    tree_conditional,
...
def init_tree(kernel):
    ...
    def blob2path(node, **kwargs):
        cancelled = False
        from sefrocut.tools.driver_to_path import DriverToPath
    ...
    def egv2path(node, **kwargs):
        from sefrocut.lihuiyu.parser import LihuiyuParser

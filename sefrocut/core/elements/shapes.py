...
from sefrocut.core.node.node import Fillrule, Linecap, Linejoin, Node
from sefrocut.core.units import (
    UNITS_PER_MM,
    UNITS_PER_PIXEL,
    UNITS_PER_POINT,
    Angle,
...
from sefrocut.kernel import CommandSyntaxError
...
from sefrocut.core.geomstr import Geomstr, stitch_geometries, stitcheable_nodes
...
def init_commands(kernel):
    ...
    def create_pattern(command, channel, _, data=None, post=None, **kwargs):
        ...
        from sefrocut.tools.pathtools import VectorMontonizer

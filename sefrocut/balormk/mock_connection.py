...
class MockConnection:
    ...
    def write(self, index=0, packet=None):
        from sefrocut.balormk.controller import GetSerialNo, ReadPort
    ...
    def _parse_list(self, packet):
        commands = []
        from sefrocut.balormk.controller import list_command_lookup
    ...
    def _parse_single(self, packet):
        from sefrocut.balormk.controller import single_command_lookup

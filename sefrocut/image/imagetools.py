...
from sefrocut.constants import RASTER_B2T, RASTER_T2B
...
from sefrocut.core.units import DEFAULT_PPI, UNITS_PER_PIXEL, Angle
...
def plugin(kernel, lifecycle=None):
    ...
    def image_linecut(command, channel, _, data, x1, y1, x2, y2, **kwargs):
        ...
        for inode in data:
            ...
            from sefrocut.extra.imageactions import create_image, mask_image

"""
Laser cutting and engraving software.

SefroCut is a fork of MeerK40t, a built-from-the-ground-up MIT licensed
open-source laser cutting software.

Original MeerK40t project: https://github.com/meerk40t/meerk40t
SefroCut fork: https://github.com/morroware/MyK40
"""
...
parser.add_argument("-V", "--version", action="store_true", help="SefroCut version")
...
parser.add_argument(
    ...
    "--no-plugins",
    action="store_true",
    help="Do not load sefrocut.plugins entrypoints",
)
parser.add_argument(
    "-A",
    "--disable-ansi",
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="run sefrocut with profiler file specified",
)
parser.add_argument(
    "-u",
    "--lock-device-config",
...
parser.add_argument(
    "-d", "--daemon", action="store_true", help="keep SefroCut in background"
)
...
def _exe(restarted, args):
    from sefrocut.external_plugins import plugin as external_plugins
    from sefrocut.internal_plugins import plugin as internal_plugins

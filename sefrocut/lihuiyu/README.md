...
The Lihuiyu module provides comprehensive support for Lihuiyu Studios Labs laser controllers, including the M2 Nano and M3 Nano series used in K40 CO2 laser cutters. This module implements the complete SefroCut device driver pattern with device service, driver, and controller components for robust LHYMicro-GL protocol handling and hardware control.
...
- **`driver.py`** - LihuiyuDriver implementation
  - Translates SefroCut cutcode operations to LHYMicro-GL commands
...
- **`plugin.py`** - Device registration and lifecycle management
  - Registers M2 and M3 Nano device variants with SefroCut kernel
...
- **SefroCut Projects**: Native .mk files with EGV export
...
File version: 1.0.01
Copyright: Unknown
Creator-Software: SefroCut v{version}
...
This module provides SefroCut with comprehensive Lihuiyu controller support, enabling reliable communication with K40 and compatible CO2 laser systems through the LHYMicro-GL protocol.

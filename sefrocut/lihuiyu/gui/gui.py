...
def plugin(service, lifecycle):
    ...
    if lifecycle == "added":
        ...
        from sefrocut.lihuiyu.gui.lhyaccelgui import LihuiyuAccelerationChart
        from sefrocut.lihuiyu.gui.lhycontrollergui import LihuiyuControllerGui
        from sefrocut.lihuiyu.gui.lhydrivergui import LihuiyuDriverGui
        from sefrocut.lihuiyu.gui.lhyoperationproperties import LhyAdvancedPanel
        from sefrocut.lihuiyu.gui.tcpcontroller import TCPController

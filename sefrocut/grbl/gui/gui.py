def plugin(service, lifecycle):
    ...
    if lifecycle == "added":
        from sefrocut.grbl.gui.grblconfiguration import GRBLConfiguration
        from sefrocut.grbl.gui.grblcontroller import GRBLController
        from sefrocut.grbl.gui.grblhardwareconfig import GRBLHardwareConfig
        from sefrocut.grbl.gui.grbloperationconfig import GRBLAdvancedPanel
        from sefrocut.grbl.gui.esp3dfilemgr import register_panel_esp3d_files

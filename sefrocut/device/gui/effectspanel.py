...
from sefrocut.device.devicechoices import get_effect_choices

# from sefrocut.core.elements.element_types import elem_group_nodes, op_nodes
...
from sefrocut.gui.wxutils import dip_size
...
class EffectsPanel(wx.Panel):
    ...
    **End-User Perspective:**
    ...
    def get_node_patterns(self, nodetype):
        ...
        from sefrocut.core.node.bootstrap import bootstrap

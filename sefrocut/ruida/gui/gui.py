def plugin(service, lifecycle):
    ...
    if lifecycle == "added":
        ...
        from sefrocut.ruida.gui.ruidaconfig import RuidaConfiguration
        from sefrocut.ruida.gui.ruidacontroller import RuidaController
        # from sefrocut.ruida.gui.ruidaoperationproperties import RuidaOperationPanel

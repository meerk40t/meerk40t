...
Ruida classes deal with interactions between SefroCut and Ruida-devices connected
...
- **Bridge Interface**: Translates between Ruida protocol and SefroCut's internal cutcode
...
- **Coordinate Mapping**: Translates between Ruida and SefroCut coordinate systems
...
- **Device Integration**: Routes commands to active SefroCut laser devices

### Device Layer (`device.py`)
- **Service Integration**: Registers as SefroCut device service
...
- **Cutcode Translation**: Converts Ruida commands to SefroCut cutcode
- **Plot Planning**: Integrates with SefroCut's plot planning system
...
annoying at times causing one to reconfigure a connection in SefroCut in order
...
- **SefroCut Units**: Internal micron-based coordinate system
...
- `RuidaDevice`: SefroCut device service integration
...
# Test file loading
python -c "from sefrocut.ruida.loader import RDLoader; print('RD loader available')"
```

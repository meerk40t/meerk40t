...
and a wxpython version <= 4.1.1."""
    ...
    if lifecycle == "preregister":
        ...
        from sefrocut.gui.fonts import wxfont_to_svg
        from sefrocut.gui.laserrender import LaserRender
        from sefrocut.gui.wxmeerk40t import wxMeerK40t
    ...
    if lifecycle == "register":
        ...
        from sefrocut.gui.guicolors import GuiColors

        kernel.add_service("colors", GuiColors(kernel))

        from sefrocut.gui.scene.scene import Scene
        ...
        from sefrocut.gui.busy import BusyInfo

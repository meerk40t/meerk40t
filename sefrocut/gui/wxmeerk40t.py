...
from sefrocut.gui.consolepanel import Console
from sefrocut.gui.navigationpanels import Navigation
from sefrocut.gui.spoolerpanel import JobSpooler
...
# except ImportError:
#     pass
from sefrocut.gui.themes import Themes
from sefrocut.gui.thread_info import ThreadInfo
from sefrocut.gui.wxmscene import SceneWindow
from sefrocut.gui.wxutils import TextCtrl, wxButton, wxStaticText
from sefrocut.kernel import CommandSyntaxError, Module, get_safe_path
from sefrocut.kernel.kernel import Job
...
class wxMeerK40t(wx.App, Module):
    ...
    def __init__(self, context, path):
        ...
        import sefrocut.gui.icons as icons
    ...
    def module_open(self, *args, **kwargs):
        ...
        from sefrocut.gui.help_assets.help_assets import asset
        ...
        from sefrocut.gui.helper import register_panel_helper

        kernel.register("wxpane/helper", register_panel_helper)

        from sefrocut.gui.wxmribbon import register_panel_ribbon

        kernel.register("wxpane/Ribbon", register_panel_ribbon)

        from sefrocut.gui.wxmscene import register_panel_scene

        kernel.register("wxpane/ScenePane", register_panel_scene)

        from sefrocut.gui.wxmtree import register_panel_tree

        kernel.register("wxpane/Tree", register_panel_tree)

        from sefrocut.gui.laserpanel import register_panel_laser

        kernel.register("wxpane/LaserPanel", register_panel_laser)

        from sefrocut.gui.position import register_panel_position

        kernel.register("wxpane/Position", register_panel_position)

        from sefrocut.gui.opassignment import register_panel_operation_assign

        kernel.register("wxpane/opassign", register_panel_operation_assign)

        from sefrocut.gui.snapoptions import register_panel_snapoptions

        kernel.register("wxpane/Snap", register_panel_snapoptions)

        from sefrocut.gui.magnetoptions import register_panel_magnetoptions

        kernel.register("wxpane/magnet", register_panel_magnetoptions)

        from sefrocut.gui.wordlisteditor import register_panel_wordlist

        kernel.register("wxpane/wordlist", register_panel_wordlist)

        # from sefrocut.gui.auitoolbars import register_toolbars
        ...
        from sefrocut.gui.dialogoptions import DialogOptions
        ...
        if context.debug_mode:
            from sefrocut.gui.mkdebug import (
            ...
            from sefrocut.gui.utilitywidgets.debugwidgets import register_widget_icon

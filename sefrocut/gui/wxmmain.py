...
from sefrocut.gui.gui_mixins import FormatPainter, Warnings
from sefrocut.gui.statusbarwidgets.defaultoperations import DefaultOperationWidget
from sefrocut.gui.statusbarwidgets.infowidget import (
    BurnProgressPanel,
    InformationWidget,
    StatusPanelWidget,
)
from sefrocut.gui.statusbarwidgets.selectionwidget import (
    SelectionOptionWidget,
    SnapOptionsWidget,
)
from sefrocut.gui.statusbarwidgets.shapepropwidget import (
    FillruleWidget,
    LinecapWidget,
    LinejoinWidget,
    PositionWidget,
)
from sefrocut.gui.statusbarwidgets.statusbar import CustomStatusBar
from sefrocut.gui.statusbarwidgets.strokewidget import ColorWidget, StrokeWidget
from sefrocut.gui.wxutils import TextCtrl, wxButton, wxComboBox, wxStaticText
from sefrocut.kernel import Job, get_safe_path, lookup_listener, signal_listener
...
class MeerK40t(MWindow):
    ...
    def sub_register(kernel):
        ...
        def contains_a_param():
            from sefrocut.core.elements.element_types import effect_nodes, elem_nodes

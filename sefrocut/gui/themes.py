...
from sefrocut.kernel import Service
...
class Themes(Service):
    ...
    def load_system_default(self):
        ...
        tp["inactive_fg"] = wx.SystemSettings.GetColour(
        ...
        if system() != "Darwin":
            ...
            if self.dark and is_a_bright_color(tp["win_bg"]):
                ...
                tp["inactive_fg"] = base_fg
        tp["pause_bg"] = wx.Colour(87, 87, 0) if self._dark else wx.Colour(200, 200, 0)

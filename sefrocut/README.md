...
[https://github.com/sefrocut/svgelements](https://github.com/sefrocut/svgelements)
...
like `Angle`, `Length`, `Color`, `Point` and `Matrix` which are used throughout SefroCut.
...
Many of these are fundamental objects within SefroCut. 

...
parser.add_argument('-gfy', '--grbl_flip_y', action='store_true', help="grbl y-flip")
parser.add_argument('-gfx', '--grbl_flip_x', action='store_true', help="grbl x-flip")
parser.add_argument('-gax', '--grbl_adjust_x', type=int, help='adjust grbl home_x position')
parser.add_argument('-gay', '--grbl_adjust_y', type=int, help='adjust grbl home_y position')

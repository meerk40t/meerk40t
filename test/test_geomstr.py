...
class TestGeomstr(unittest.TestCase):
    ...
    def test_beam_table_union_fail(self):
        t = [
            ((-43.46456692913385, -43.46456692913385), (0.0, 0.0), (41.0, 0.0), (0.0, 0.0), (43.46456692913385, -43.46456692913385)),
             ((43.46456692913385, -43.46456692913385), (0.0, 0.0), (41.0, 0.0), (0.0, 0.0), (43.46456692913385, 43.46456692913385)),
             ((43.46456692913385, 43.46456692913385), (0.0, 0.0), (41.0, 0.0), (0.0, 0.0), (-43.46456692913385, 43.46456692913385)),
             ((-43.46456692913385, 43.46456692913385), (0.0, 0.0), (41.0, 0.0), (0.0, 0.0), (-43.46456692913385, -43.46456692913385)),
             ((-28.945818991623074, 16.225195143415156), (0.0, 0.0), (41.0, 1.0), (0.0, 0.0), (53.337369676799284, 44.2635826845245)),
             ((53.337369676799284, 44.2635826845245), (0.0, 0.0), (41.0, 1.0), (0.0, 0.0), (25.298982135689936, 126.54677135294685)),
             ((25.298982135689936, 126.54677135294685), (0.0, 0.0), (41.0, 1.0), (0.0, 0.0), (-56.984206532732415, 98.50838381183752)),
             ((-56.984206532732415, 98.50838381183752), (0.0, 0.0), (41.0, 1.0), (0.0, 0.0), (-28.945818991623074, 16.225195143415156)),
             ((24.566929133858267, -43.46456692913385), (0.0, 0.0), (41.0, 2.0), (0.0, 0.0), (111.49606299212597, -43.46456692913385)),
             ((111.49606299212597, -43.46456692913385), (0.0, 0.0), (41.0, 2.0), (0.0, 0.0), (111.49606299212597, 43.46456692913385)),
             ((111.49606299212597, 43.46456692913385), (0.0, 0.0), (41.0, 2.0), (0.0, 0.0), (24.566929133858267, 43.46456692913385)),
             ((24.566929133858267, 43.46456692913385), (0.0, 0.0), (41.0, 2.0), (0.0, 0.0), (24.566929133858267, -43.46456692913385)),
             ((12.95553507653257, 58.38654496810442), (0.0, 0.0), (41.0, 3.0), (0.0, 0.0), (79.95047955296334, 2.9938403225594072)),
             ((79.95047955296334, 2.9938403225594072), (0.0, 0.0), (41.0, 3.0), (0.0, 0.0), (135.34318419850837, 69.98878479899018)),
             ((135.34318419850837, 69.98878479899018), (0.0, 0.0), (41.0, 3.0), (0.0, 0.0), (68.34823972207758, 125.38148944453519)),
             ((68.34823972207758, 125.38148944453519), (0.0, 0.0), (41.0, 3.0), (0.0, 0.0), (12.95553507653257, 58.38654496810442))
             ]
        ...
        bt2 = BeamTable(g)
        bt2.compute_beam_bo()
        for i in range(len(bt2._nb_events)):
            e = bt2._nb_events[i]
            a = bt2._nb_scan[i]
            print(f"{e}, {a}")

...
class Kernel(Device):
    ...
    * The keymap object
    ...
    def default_alias(self):
        ...
        self.alias['+right'] = "loop position right 1mm;loop position execute"
        self.alias['+left'] = "loop position left 1mm;loop position execute"
        self.alias['+up'] = "loop position up 1mm;loop position execute"
        self.alias['+down'] = "loop position down 1mm;loop position execute"
        ...
        self.alias['-right'] = "end position right 1mm"
        self.alias['-left'] = "end position left 1mm"
        self.alias['-up'] = "end position up 1mm"
        self.alias['-down'] = "end position down 1mm"

...
class Navigation(wx.Frame):
    ...
    def set_project(self, project):
        ...
        self.spin_step_size.SetValue(project[float, "step_size", self.spin_step_size.GetValue()])
        self.spin_pulse_time.SetValue(project[float, "pulse_time", self.spin_pulse_time.GetValue()])
    ...
    def on_spin_pulse_time(self, event):  # wxGlade: Navigate.<event_handler>
        self.project["pulse_time"] = self.spin_pulse_time.GetValue()

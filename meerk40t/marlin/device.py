...
from .controller import MarlinController
from .driver import MarlinDriver


class MarlinDevice(Service):
    """
    MarlinDevice is driver for the Gcode Controllers
    """
    ...
    def __init__(self, kernel, path, *args, choices=None, **kwargs):
        ...
        choices = [
            ...
            },
            {
                ...
                "label": _("Flip X"),
                "tip": _(
                    "+X is standard for marlin but sometimes settings can flip that."
                ),
            ...
            },
            {
                ...
                "label": _("Flip Y"),
                "tip": _(
                    "-Y is standard for marlin but sometimes settings can flip that."
                ),
                "subsection": "_10_Flip Axis",
                "signals": "bedsize",
            },
        ...
        choices = [
            {
                ...
                "tip": _("Select the interface type for the device"),
        ...
        self.register_choices("marlin-connection", choices)
        ...
        choices = [
            {
                ...
                "label": _("Use M3"),
                "tip": _(
                    "Uses M3 rather than M4 for laser start (see Marlin docs for additional info)"
                ),
            },
            {
                ...
                "tip": _(
                    "Ensure device is completely initialized before sending data. This is usually known to be valid at the 'Marlin xx.x' version message."
                ),
            ...
            },
            {
                ...
                "tip": _(
                    "If for some reason the device needs a different welcome validator than 'Marlin' (default), for example, somewhat custom marlin-like firmware"
                ),
                "conditional": (self, "requires_validation"),
                "section": "_40_Validation",
            },
        ]
        self.register_choices("marlin-advanced", choices)

        self.driver = MarlinDriver(self)
        self.controller = MarlinController(self)
        ...
        @self.console_command(
            "viewport_update",
            hidden=True,
            help=_("Update Marlin codes for movement"),
        )

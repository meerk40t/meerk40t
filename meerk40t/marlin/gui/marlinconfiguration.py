    ...
    def __init__(self, *args, context=None, **kwds):
        ...
        if self.context.permit_serial:
            ...
            self.radio_serial.SetToolTip(
                _(
                    "Select this if you have a device running through a serial connection."
                )
            )
        ...
        if self.context.permit_tcp:
            ...
            self.radio_tcp.SetToolTip(
                _("Select this if the device is contacted via TCP connection")
            )
...
class MarlinConfiguration(MWindow):
    def __init__(self, *args, **kwds):
        ...
        self.SetIcon(_icon)
        self.SetTitle(_("Marlin-Configuration"))
        ...
        panel_main = ChoicePropertyPanel(
            ...
            choices="marlin-connection",
        )
        panel_global = ChoicePropertyPanel(
            self, wx.ID_ANY, context=self.context, choices="marlin-advanced"
        )
    ...
    @staticmethod
    def submenu():
        return "Device-Settings", "Marlin-Configuration"

    @signal_listener("marlin;response")
            ...
            if self._requested_status:
                ...
                for resp in responses:
                    ...
                    if index >= 0 and value is not None:
                        self.context.controller.marlin_settings[index] = value
                    if index == 21:

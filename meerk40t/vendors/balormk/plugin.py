...
def plugin(kernel, lifecycle):
    if lifecycle == "plugins":
        from meerk40t.vendors.balormk import galvo_commands
        from meerk40t.vendors.balormk.gui import gui
    ...
    if lifecycle == "register":
        from meerk40t.vendors.balormk.device import BalorDevice

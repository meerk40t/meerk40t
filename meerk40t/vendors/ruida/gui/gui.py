def plugin(service, lifecycle):
    ...
    if lifecycle == "added":
        ...
        from meerk40t.vendors.ruida.gui.ruidaconfig import RuidaConfiguration
        from meerk40t.vendors.ruida.gui.ruidacontroller import RuidaController
        # from meerk40t.vendors.ruida.gui.ruidaoperationproperties import RuidaOperationPanel

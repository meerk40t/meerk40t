...
"""
from meerk40t.vendors.ruida.control import RuidaControl
from meerk40t.vendors.ruida.device import RuidaDevice
from meerk40t.vendors.ruida.emulator import RuidaEmulator
from meerk40t.vendors.ruida.loader import RDLoader
from meerk40t.vendors.ruida.rdjob import RDJob
    ...
    if lifecycle == "register":
        ...
        kernel.register(
            "dev_info/ruida-beta",
            {
                ...
                "extended_info": _("This driver has been tested on Linux only so far.")+ "\n" +_("Please provide feedback if you find issues."),
                "priority": -1,

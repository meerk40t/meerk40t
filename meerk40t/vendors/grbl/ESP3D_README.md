...
**Windows PowerShell:**
```powershell
python -m meerk40t.vendors.grbl.esp3d_emulator
```

**With custom host/port:**
```powershell
python -m meerk40t.vendors.grbl.esp3d_emulator --host 0.0.0.0 --port 8080
```
...
```
1. Start emulator: python -m meerk40t.vendors.grbl.esp3d_emulator

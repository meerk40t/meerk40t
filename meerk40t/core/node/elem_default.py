...
class ElemNode(Node):
    ...
    def __init__(self, data_object, matrix=None, **kwargs):
    ...
    def default_map(self, default_map=None):
        default_map = super(ElemNode, self).default_map(default_map=default_map)
        default_map['element_type'] = self.__class__.__name__
        return default_map

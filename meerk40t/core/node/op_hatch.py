    ...
    def preprocess(self, context, matrix, commands):
        ...
        def hatch():
            ...
            for p in range(self.implicit_passes):
                ...
                if 'line_color' not in chain_settings or chain_settings['line_color'] is None or chain_settings['line_color'].value is None:
                    chain_settings['line_color'] = Color(chain_settings.get('color', 'black'))

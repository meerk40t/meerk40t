...
DEFAULT_KEYMAP = {
    ...
    "alt+shift+right": ("translate 10px 0",),
    "alt+shift+left": ("translate -10px 0",),
    "alt+shift+up": ("translate 0 -10px",),
    "alt+shift+down": ("translate 0 10px",),
    "alt+right": ("translate 10px 0",),
    "alt+left": ("translate -10px 0",),
    "alt+up": ("translate 0 -10px",),
    "alt+down": ("translate 0 10px",),

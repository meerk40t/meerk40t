...
class BindAlias(Modifier):
    ...
    def default_keymap(self):
        ...
        self.keymap["control+f"] = "dialog_fill"
        self.keymap["control+s"] = "dialog_stroke"
        ...
        self.keymap["f8"] = "dialog_path"
        self.keymap["f9"] = "dialog_transform"
        self.keymap["control+f9"] = "dialog_flip"

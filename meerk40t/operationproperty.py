...
class OperationProperty(wx.Frame, Module):
    ...
    def __do_layout(self):
        ...
        passes_sizer = wx.StaticBoxSizer(wx.StaticBox(self.advanced_panel, wx.ID_ANY, _("Passes")), wx.VERTICAL)
        sizer_22 = wx.BoxSizer(wx.HORIZONTAL)
        advanced_ppi_sizer = wx.StaticBoxSizer(wx.StaticBox(self.advanced_panel, wx.ID_ANY, _("PPI Advanced")), wx.HORIZONTAL)
        sizer_19 = wx.BoxSizer(wx.VERTICAL)
        sizer_20 = wx.BoxSizer(wx.HORIZONTAL)
        advanced_sizer = wx.StaticBoxSizer(wx.StaticBox(self.advanced_panel, wx.ID_ANY, _("Speedcode Advanced")), wx.VERTICAL)
        sizer_12 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_11 = wx.BoxSizer(wx.HORIZONTAL)
        param_sizer = wx.BoxSizer(wx.VERTICAL)
        raster_sizer = wx.StaticBoxSizer(wx.StaticBox(self.raster_panel, wx.ID_ANY, _("Raster")), wx.VERTICAL)
        sizer_2 = wx.StaticBoxSizer(wx.StaticBox(self.raster_panel, wx.ID_ANY, _("Start Preference")), wx.VERTICAL)

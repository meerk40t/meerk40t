...
class LihuiyuAccelerationChartPanel(ScrolledPanel):
    ...
    def __set_properties(self):
        ...
        self.text_vector_accel_1.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=1))
        self.text_vector_accel_1.Enable(False)
        self.text_vector_accel_2.SetMinSize((55, 23))
        self.text_vector_accel_2.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=2))
        self.text_vector_accel_2.Enable(False)
        self.text_vector_accel_3.SetMinSize((55, 23))
        self.text_vector_accel_3.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=3))
        self.text_vector_accel_3.Enable(False)
        self.text_vector_accel_4.SetMinSize((55, 23))
        self.text_vector_accel_4.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=4))
        ...
        self.text_vraster_accel_1.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=1))
        self.text_vraster_accel_1.Enable(False)
        self.text_vraster_accel_2.SetMinSize((55, 23))
        self.text_vraster_accel_2.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=2))
        self.text_vraster_accel_2.Enable(False)
        self.text_vraster_accel_3.SetMinSize((55, 23))
        self.text_vraster_accel_3.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=3))
        self.text_vraster_accel_3.Enable(False)
        self.text_vraster_accel_4.SetMinSize((55, 23))
        self.text_vraster_accel_4.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=4))
        ...
        self.text_raster_accel_1.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=1))
        self.text_raster_accel_1.Enable(False)
        self.text_raster_accel_2.SetMinSize((55, 23))
        self.text_raster_accel_2.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=2))
        self.text_raster_accel_2.Enable(False)
        self.text_raster_accel_3.SetMinSize((55, 23))
        self.text_raster_accel_3.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=3))
        self.text_raster_accel_3.Enable(False)
        self.text_raster_accel_4.SetMinSize((55, 23))
        self.text_raster_accel_4.SetToolTip(_("Upper limit for accel level {acceleration}").format(acceleration=4))

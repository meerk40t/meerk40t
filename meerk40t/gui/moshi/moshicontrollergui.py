...
class MoshiControllerGui(MWindow):
    def __init__(self, *args, **kwds):
        ...
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Free Motor", "Sends Free Motor (Unlock Rail) command")
    ...
    def __set_properties(self):
        ...
        self.button_device_connect.SetToolTipString("Force connection/disconnection from the device.")
        ...
        self.spin_device_index.SetToolTipString("-1 match anything. 0-5 match exactly that value.")
        self.text_device_address.SetMinSize((55, 23))
        self.spin_device_address.SetToolTipString("-1 match anything. 0-5 match exactly that value.")
        self.text_device_bus.SetMinSize((55, 23))
        self.spin_device_bus.SetToolTipString("-1 match anything. 0-5 match exactly that value.")
        self.text_device_version.SetMinSize((55, 23))
        self.spin_device_version.SetToolTipString("-1 match anything. 0-255 match exactly that value.")

...
class RasterSettingsPanel(wx.Panel):
    def __init__(self, *args, context=None, node=None,  **kwds):
        ...
        self.panel_start = PanelStartPreference(self, wx.ID_ANY, context=context, node=node)
...
class LhyAdvancedPanel(wx.Panel):
    def __init__(self, *args, context=None, node=None, **kwds):
        ...
        self.Bind(wx.EVT_CHECKBOX, self.on_check_shift_enabled, self.check_shift_enabled)
        # end wxGlade

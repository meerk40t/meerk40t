...
class PropertyColor(wx.BoxSizer):
    def __init__(self, parent, *args, **kwds):
        ...
        self.Add(self.col_stroke, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        self.Add(self.col_fill, 0, wx.ALIGN_CENTER_VERTICAL, 0)
...
class PropertyHolder(wx.Panel):
    def __init__(self, *args, context=None, **kwds):
        ...
        for handler in self.registered_handlers:
            sub_sizer.Add(handler, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        main_sizer.Add(sub_sizer, 0, 0, 0)
...
def register_panel_common_properties(window, context):
    ...
    pane.control = PropertyHolder(window, wx.ID_ANY, context=context)
    pane.submenu = "_40_" + _("Editing")
    window.on_pane_create(pane)
    context.register("pane/common_property", pane)

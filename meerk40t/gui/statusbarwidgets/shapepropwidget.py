...
class LinecapWidget(StatusBarWidget):
    ...
    def GenerateControls(self, parent, panelidx, identifier, context):
        ...
        self.btn_cap_butt.SetBitmap(
            icon_cap_butt.GetBitmap(resize=self.parent.MinHeight - 5, buffer=1)
        )
        ...
        self.btn_cap_round.SetBitmap(
            icon_cap_round.GetBitmap(resize=self.parent.MinHeight - 5, buffer=1)
        )
        ...
        self.btn_cap_square.SetBitmap(
            icon_cap_square.GetBitmap(resize=self.parent.MinHeight - 5, buffer=1)
        )
...
class LinejoinWidget(StatusBarWidget):
    ...
    def GenerateControls(self, parent, panelidx, identifier, context):
        ...
        self.btn_join_bevel.SetBitmap(
            icon_join_bevel.GetBitmap(resize=self.parent.MinHeight - 5, buffer=1)
        )
        ...
        self.btn_join_round.SetBitmap(
            icon_join_round.GetBitmap(resize=self.parent.MinHeight - 5, buffer=1)
        )
        ...
        self.btn_join_miter.SetBitmap(
            icon_join_miter.GetBitmap(resize=self.parent.MinHeight - 5, buffer=1)
        )

...
class ImagePropertyPanel(ScrolledPanel):
    ...
    def __do_layout(self):
        ...
        sizer_dither_raster = wx.BoxSizer(wx.HORIZONTAL)
        sizer_dither_raster.Add(sizer_dither, 1, wx.EXPAND, 0)
        sizer_dither_raster.Add(sizer_rasterwizard, 1, wx.EXPAND, 0)

        sizer_main.Add(sizer_dither_raster, 0, wx.EXPAND, 0)

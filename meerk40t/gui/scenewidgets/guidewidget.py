    ...
    def event(self, window_pos=None, space_pos=None, event_type=None):
        ...
        if event_type == "hover":
            ...
            if self.scene.has_magnets():
                ...
                kind = (
                    wx.ITEM_CHECK
                    if self.scene.magnet_attraction == 0
                    else wx.ITEM_NORMAL
                )
                ...
                kind = (
                    wx.ITEM_CHECK
                    if self.scene.magnet_attraction == 1
                    else wx.ITEM_NORMAL
                )
                ...
                kind = (
                    wx.ITEM_CHECK
                    if self.scene.magnet_attraction == 2
                    else wx.ITEM_NORMAL
                )
                ...
                kind = (
                    wx.ITEM_CHECK
                    if self.scene.magnet_attraction == 3
                    else wx.ITEM_NORMAL
                )
                ...
                kind = (
                    wx.ITEM_CHECK
                    if self.scene.magnet_attraction == 4
                    else wx.ITEM_NORMAL
                )
                ...
                kind = (
                    wx.ITEM_CHECK
                    if self.scene.magnet_attraction == 5
                    else wx.ITEM_NORMAL
                )

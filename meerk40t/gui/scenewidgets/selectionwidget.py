...
class BorderWidget(Widget):
    ...
    def process_draw(self, gc):
        ...
        if self.master.show_border:
            ...
            try:
                font = wx.Font(self.master.font_size, wx.FONTFAMILY_SWISS, wx.NORMAL, wx.FONTWEIGHT_BOLD)
            except TypeError:
                font = wx.Font(int(self.master.font_size), wx.FONTFAMILY_SWISS, wx.NORMAL, wx.FONTWEIGHT_BOLD)
        ...
        if abs(self.master.rotated_angle) > 0.001:
            try:
                font = wx.Font(
                    0.75 * self.master.font_size, wx.FONTFAMILY_SWISS, wx.NORMAL, wx.FONTWEIGHT_BOLD
                )
            except TypeError:
                font = wx.Font(
                    int(0.75 * self.master.font_size), wx.FONTFAMILY_SWISS, wx.NORMAL, wx.FONTWEIGHT_BOLD
                )
            gc.SetFont(font, self.scene.colors.color_manipulation)
...
class ReferenceWidget(Widget):
    ...
    def process_draw(self, gc):
        ...
        # gc.DrawRectangle(self.left, self.top, self.width, self.height)
        try:
            font = wx.Font(0.75 * self.master.font_size, wx.FONTFAMILY_SWISS, wx.NORMAL, wx.FONTWEIGHT_BOLD)
        except TypeError:
            font = wx.Font(
                int(0.75 * self.master.font_size), wx.FONTFAMILY_SWISS, wx.NORMAL, wx.FONTWEIGHT_BOLD
            )

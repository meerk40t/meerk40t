...
class MachineOriginWidget(Widget):
    ...
    def process_draw(self, gc):
        ...
        display_to_scene = context.space.map("display", "scene")

        x, y = display_to_scene.point_in_matrix_space((0, 0))
        x_dx, x_dy = display_to_scene.point_in_matrix_space((50000, 0))
        xa1_dx, xa1_dy = display_to_scene.point_in_matrix_space((45000, 5000))
        xa2_dx, xa2_dy = display_to_scene.point_in_matrix_space((45000, -5000))
        y_dx, y_dy = display_to_scene.point_in_matrix_space((0, 50000))
        ya1_dx, ya1_dy = display_to_scene.point_in_matrix_space((5000, 45000))
        ya2_dx, ya2_dy = display_to_scene.point_in_matrix_space((-5000, 45000))

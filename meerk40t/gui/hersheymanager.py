...
class LineTextPropertPanel(wx.Panel):
    def __init__(
        ...
        **kwds,
        ...
        sizer_text = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, _("Content")), wx.HORIZONTAL)
        ...
        self.list_fonts.SetToolTip(_("Select to preview the font, double-click to apply it"))

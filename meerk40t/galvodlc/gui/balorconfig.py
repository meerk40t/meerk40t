...
class BalorConfiguration(MWindow):
    def __init__(self, *args, **kwds):
        ...
        self.SetHelpText("galvoconfig")
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(icons8_administrative_tools.GetBitmap())
        self.SetIcon(_icon)
        self.SetTitle(_("Galvo-Configuration"))
        ...
        options = (
            ("galvo", "Galvo"),
            ("galvo-redlight", "Redlight"),
            ("galvo-global", "Global"),
            ("galvo-global-timing", "Timings"),
            ("galvo-extra", "Extras"),
            #            ("galvo-corfile", "Correction"),
        )
        self.test_bits = ""
        injector = (
            {
    ...
    def on_corfile_changed(self, origin, *args):
        from meerk40t.galvodlc.controller import GalvoController

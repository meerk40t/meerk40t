...
def plugin(service, lifecycle):
    ...
    def galvo_save(channel, _, filename, data=None, **kwargs):
        ...
        try:
            with open(filename, "w") as f:
                driver = GalvoDriver(service, force_mock=True)
                job = LaserJob(filename, list(data.plan), driver=driver)
                from meerk40t.galvodlc.controller import list_command_lookup
    ...
    def galvo_raw(
        ...
        **kwgs,
        ...
        """
        from meerk40t.galvodlc.controller import (
            list_command_lookup,
    ...
    def codes_update(channel, filename, **kwargs):
        ...
        from meerk40t.galvodlc.clone_loader import load_sys
        ...
        if service.clone_sys == "chunks":
            from meerk40t.galvodlc.clone_loader import load_chunks

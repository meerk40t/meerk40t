...
class RotarySettingsPanel(ScrolledPanel):
    def __init__(self, *args, context=None, **kwds):
        ...
        self.rotary = context.device.rotary
    ...
    def pane_show(self):
        ...
        self.checkbox_rotary.SetValue(self.rotary.active)
...
class RotarySettings(MWindow):
    def __init__(self, *args, **kwds):
        ...
        self.panel = RotarySettingsPanel(self, context=self.context)
